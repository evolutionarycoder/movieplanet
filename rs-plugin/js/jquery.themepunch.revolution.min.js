...
(function (e, t) {
    ...
    function L(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (d == 6)R = .6;
            TweenLite.fromTo(H, X, {left: j, top: F, scale: R, opacity: I, rotation: r.rotate}, {
                opacity   : 1,
                rotation  : 0,
                left      : 0,
                top       : 0,
        ...
        n.find(".tp-caption").each(function (n) {
            ...
            if (c == 0) {
                                ...
                                try {
                                    ...
                                    var a = setInterval(function () {
                                        if (YT != t)if (typeof YT.Player != t && typeof YT.Player != "undefined") {
                                            ...
                                            } else u = new YT.Player(h, {events: {onStateChange: j}});
                ...
                if (!i) {
                    ...
                    var F = new TimelineLite({smoothChildTiming: true, onStart: B});
                    if (r.fullScreenAlignForce == "on") {
                    }
                    var W = l;
                    ...
                    if (l.hasClass("customin"))V = U(V, l.data("customin")); else if (l.hasClass("randomrotate")) {
                    ...
                    } else if (l.hasClass("lfr") || l.hasClass("skewfromright"))V.x = 15 + r.width; else if (l.hasClass("lfl") || l.hasClass("skewfromleft"))V.x = -15 - d; else if (l.hasClass("sfl") || l.hasClass("skewfromleftshort"))V.x = -50; else if (l.hasClass("sfr") || l.hasClass("skewfromrightshort"))V.x = 50; else if (l.hasClass("lft"))V.y = -25 - v; else if (l.hasClass("lfb"))V.y = 25 + r.height; else if (l.hasClass("sft"))V.y = -50; else if (l.hasClass("sfb"))V.y = 50;
                    if (l.hasClass("skewfromright") || l.hasClass("skewfromrightshort"))V.skewX = -85; else if (l.hasClass("skewfromleft") || l.hasClass("skewfromleftshort"))V.skewX = 85;
        ...
        revolution        : function (i) {
            ...
            return this.each(function () {
                ...
                if (!u.hasClass("revslider-initialised")) {
                    ...
                    if (w == 1 && E < 7) {
                        u.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#922;"> The Current Version of jQuery:' + b + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>")
                    }
                    if (w > 1)o.ie = false;
